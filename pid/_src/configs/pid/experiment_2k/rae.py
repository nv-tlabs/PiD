...
_DINOV2_MODEL_CONFIG = _common_model_overrides(state_ch=768)
_DINOV2_MODEL_CONFIG["net"] = {
    "lq_latent_channels": 768,
    "latent_spatial_down_factor": 16,
}

PID_RES2K_SR4X_OFFICIAL_DINOV2_DISTILL_4STEP = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(group="pid_official", name="PiD_res2k_sr4x_official_dinov2_distill_4step"),
        model=dict(config=_DINOV2_MODEL_CONFIG),
    ),
)
