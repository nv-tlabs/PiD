...
import pid._ext.imaginaire.datasets.webdataset.webdataset
from pid._ext.imaginaire.utils.distributed import get_world_size
...
class DataLoader(webdataset.WebLoader):
    ...
    def __init__(
        self,
        dataset: pid._ext.imaginaire.datasets.webdataset.webdataset.Dataset,
        batch_size: int = 1,
        *args,
        **kw,
    ):  # type: ignore
