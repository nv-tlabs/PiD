...
PID_TEACHER_CKPT = "checkpoints/PiD_v1pt5_res2kto4k_sr4x_official_flux_undistilled/model_ema_bf16.pth"
...
PYTHONPATH=. torchrun --nproc_per_node=4 --master_port=12350 \
    ...
    -- experiment="pid_v1pt5_student_flux_h1024_d4_res_2048_distill_debug"
"""
PID_V1PT5_STUDENT_FLUX_H1024_D4_RES_2048_DISTILL: LazyDict = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(
            ...
            name="pid_v1pt5_student_flux_h1024_d4_res_2048_distill",
        ),
        optimizer=dict(
            lr=1e-5,
            weight_decay=0.0,
...
PYTHONPATH=. torchrun --nproc_per_node=4 --master_port=12350 \
    -m scripts.train --config=pid/_src/configs/pid_training/config.py \
    -- experiment="pid_v1pt5_student_flux_h1024_d4_res_2048_to_3840_distill_debug"
"""
PID_V1PT5_STUDENT_FLUX_H1024_D4_RES_2048_TO_3840_DISTILL: LazyDict = LazyDict(
    dict(
        defaults=[
        ...
        job=dict(
            group="pid_training_v1pt5",
            name="pid_v1pt5_student_flux_h1024_d4_res_2048_to_3840_distill",
        ),
        model_parallel=dict(
            context_parallel_size=4,
        ),
...
for _item, _item_debug in [
    [
        PID_V1PT5_STUDENT_FLUX_H1024_D4_RES_2048_DISTILL,
        _build_debug_run(PID_V1PT5_STUDENT_FLUX_H1024_D4_RES_2048_DISTILL),
    ],
    [
        PID_V1PT5_STUDENT_FLUX_H1024_D4_RES_2048_TO_3840_DISTILL,
        _build_debug_run(PID_V1PT5_STUDENT_FLUX_H1024_D4_RES_2048_TO_3840_DISTILL),
    ],
]:
    cs.store(
        group="experiment",
